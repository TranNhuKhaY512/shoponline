...
?>  
<form method="POST" action="./modules/quanlichinhsach/xuly.php?idchinhsach=<?php echo $_GET['idchinhsach']?>" enctype="multipart/form-data"> <!-- muon gui hinh anh qua post pha them enctype -->  
        <tr>
        ...
        <tr>
            <td class="qlchinhsach1">Danh mục chính sách</td>
            <td >
        ...
        <tr  class="btn_thêm_menu">
            ...
            <td colspan ='2'><input type="submit" name='suachinhsach' value='Cập nhật chính sách'></td>
        </tr>
    </form>
<?php
    }
