<div class="quanlymenu">
            ...
            <table class='qlchinhsach'>
                <form method="POST" action="./modules/quanlichinhsach/xuly.php" enctype="multipart/form-data"> <!-- muon gui hinh anh qua post pha them enctype -->
                    <tr>
                        <td class="qlchinhsach1">Tên chính sách</td>
                        <td ><input type="text" name="tenchinhsach" class="qlchinhsach2" required></td>
                    </tr>
                    
                    <tr>
                        <td  class="qlchinhsach1">Nội dung</td>
                        <td  ><textarea rows="10" name="noidung" class="qlchinhsach2" id="noidung" required></textarea></td>
                    </tr>
                    <tr>
                        <td  class="qlchinhsach1">Danh muc chính sách</td>
                        <td >
                            <select name="id_tenchinhsach" class="qlchinhsach2" required>
                                <?php
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="tinhtrang"  class="qlchinhsach2" required>
