...
?>  
<form method="POST" action="./modules/quanliblog/xuly.php?idbaibao=<?php echo $_GET['idbaibao']?>" enctype="multipart/form-data"> <!-- muon gui hinh anh qua post pha them enctype -->  
        <tr>
        ...
        <tr>
            ...
            <td class="qlchinhsach2">
                ...
                <img src="modules/quanliblog/imgblog/<?php echo $row['hinhanh']?>" width=100px >
            </td>
        </tr>
        <tr>
        ...
        <tr  class="btn_thêm_menu">
            ...
            <td colspan ='2'><input type="submit" name='suabaibao' value='Cập nhật bài báo'></td>
        </tr>
    </form>
<?php
    }
