...
?>
  ...
  <th><?php echo $i ?></th>
    ...
    <th><img style="width:50px;max-height:80px;" src = "modules/quanlisanpham/imgspham/<?php echo $row['hinhanh']; ?>"></th>
  ...
  <tr>
    <th>
        <a class="inputdonhang" href="index.php?action=quanlidonhang&query=lietke">< Quay lại trang quản lý đơn hàng</a> 
    </th>
  </tr>
