    ...
    <form method="POST" action="./modules/quanlisanpham/xuly.php" enctype="multipart/form-data">
        <table class='thêm_menu'>
            <tr>
                ...
                <td class="thêm_menu"><input type="text" name="tensanpham" required></td>
            </tr>
            <tr>
                <td class="thêm_menu">Mã sp</td>
                <td class="thêm_menu"><input type="text" name="id_sanpham" required></td>
            </tr>
            <tr>
                <td class="thêm_menu">Khuyến mãi %</td>
                <td class="thêm_menu"><input type="number" name="km" required></td>
            </tr>
            <tr>
                <td class="thêm_menu">Giá sp</td>
                <td class="thêm_menu"><input type="number" name="giasp" required></td>
            </tr>
            <tr>
                <td class="thêm_menu">Giá gốc Khuyến mãi</td>
                <td class="thêm_menu"><input type="number" name="giagockm" required></td>
            </tr>
<!-- Trong phần HTML -->
<tr>
    ...
    <td class="them_size">
        ...
        ?>
<a href="index.php?action=quanlisanpham&query=kichthuoc">Thêm </a>
...
<tr class="soluong-inputs">
    <td class="thêm_menu">Số Lượng (theo kích thước)</td>
    <td class="them_so_luong" id="soluong-inputs">
...
<script>
    // Tự động thêm input nhập số lượng tương ứng với các kích thước được chọn (checkbox).
$(document).ready(function () {
    ...
    // cho phép người dùng nhập số vào các trường số lượng
    $(document).on('input', '.soluong-input', function () {
        updateTotalQuantity();
    });
//  hiển thị input khi checkbox kích thước được chọn.
    function updateTotalQuantity() {
        ...
        $('#tong-soluong').val(totalQuantity);
            ...
            <tr>
                ...
                <td class="thêm_menu"><input type="file" name="hinhanh" required></td>
            </tr>
            <tr>
            <td class="thêm_menu">Tóm tắt</td>
            <td class="thêm_menu">
                <textarea rows="10" cols="50" name="tomtat" required wrap="soft"></textarea>
            </td>
            </tr>
            ...
            <tr class="btn_thêm_menu" style="text-align: center;">
