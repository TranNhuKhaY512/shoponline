...
<script>
    // Hàm để xử lý xóa
        ...
        if (confirm('Bạn có chắc chắn muốn xóa?')) {
            window.location.href = 'modules/quanlichinhanh/xuly.php?idchinhanh=' + id;
        }
        }
</script>
            <tr>
                ...
                <td>
                    ...
                    <a href="javascript:void(0);" onclick="confirmDelete(<?php echo $row['id_chinhanh']; ?>)">Xóa</a>  | 
                     <a href="index.php?action=quanlichinhanh&query=sua&idchinhanh=<?php echo $row['id_chinhanh']?>">Sửa</a> 
