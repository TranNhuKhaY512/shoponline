...
<?php
// phân trang, nếu trang không có hoặc bằng 1, bắt đầu từ trang đầu tiên ($begin = 0).
if(isset($_GET['trang'])){
    $page = $_GET['trang'];
}else{
    $page = '';
...
<tr style="text-align: center;">
    ...
    <th><img style="width:100px;max-height:100px" src="modules/quanlisanpham/imgspham/<?php echo $row['hinhanh'] ?>"></th>
...
// phân trang 20 sp/trang
  ...
  <!-- hiển thị nút chuyển trang  -->        
    <span class="page-item"><a class="page-link" <?php if($i == $page){echo 'style="background: #bfbfbf;"';}else{ echo ''; } ?>
       href="index.php?action=quanlikho&query=lietke&trang=<?php echo $i ?>"><?php echo $i ?></a></span>  
