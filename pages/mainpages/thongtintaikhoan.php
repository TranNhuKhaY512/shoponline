...
<h1 style="text-align:center;"> TÀI KHOẢN CỦA BẠN </h1>
            ...
            <div >
            <?php
                $sql_pro = "SELECT * FROM tbl_khachhang WHERE tbl_khachhang.id_khachhang = '$_GET[id]'  LIMIT 1"; //lấy tất cả sản phẩm dựa vào id 
            ...
            ?>
                ...
                <form action="./index.php?quanly=suathongtintaikhoann&id=<?php echo $row_taikhoan['id_khachhang'] ?>" method="POST">
                    <button name="suathongtin" >Cập nhật thông tin tài khoản </button>
                </form>
                </div>
            </div> 
            <?php  }?>
